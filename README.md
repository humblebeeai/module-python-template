...
[![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/humblebeeai/module-python-template/2.build-publish.yml?logo=GitHub)](https://github.com/humblebeeai/module-python-template/actions/workflows/2.build-publish.yml)
[![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/humblebeeai/module-python-template?logo=GitHub&color=blue)](https://github.com/humblebeeai/module-python-template/releases)
...
- If you want to use the template repository directly, just click the **[Use this template](https://github.com/new?template_name=module-python-template&template_owner=humblebeeai)** button and follow the instructions.
- You can use **cookiecutter** to generate a new project from **[cookiecutter](https://github.com/humblebeeai/module-python-template/tree/cookiecutter)** branch:

    ```sh
    # Clone the cookiecutter branch:
    git clone -b cookiecutter https://github.com/humblebeeai/module-python-template.git
...
1. Download archived **zip** file from [**releases**](https://github.com/humblebeeai/module-python-template/releases).
...
```sh
pip install git+https://github.com/humblebeeai/module-python-template.git
```
...
1. Download **`.whl`** or **`.tar.gz`** file from [**releases**](https://github.com/humblebeeai/module-python-template/releases)
2. Install with pip:
